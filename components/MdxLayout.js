        ...
        <>
            <nav className="py-3">
                <ul className="flex flex-row items-center gap-x-2 max-w-prose mx-auto">
                    <li><Link href="/">Colin Steidtmann</Link></li>
                    {pathLinks.map((obj) => {
                        return (
                            <>
                                <li key={obj.part + "icon"}><ChevronRightIcon className="h-3 w-3" /></li>
                                <li key={obj.part}><Link href={obj.href} >{obj.part}</Link></li>
                            </>
            ...
            <div className="bg-[#fdfdfd] min-h-screen">
                <div className="prose mx-auto">
                    <p className="pt-4"><time dateTime={lastmod}>

...
<Pic src="./2019-website.png" />

So, how should I rebuild it? I could use pay for a site from Squarespace, Wix, or
Wordpress, but then I'd be limited in ownership and creative freedom, and I would
be paying 10x what I pay now ($12/year). A week ago I stumbled across [MDX](https://mdxjs.com/),
aka [Markdown](https://www.markdownguide.org/) with the ability to interweave JavaScript
in it. Markdown is a very friendly way to write and much more inviting to me, eg.
I can write headers with `# Header` or italics with `*word*` instead of `<h1>Header</h1>` and `<em>word</em>`.Now, I'll write the steps I followed to set-up this site,
